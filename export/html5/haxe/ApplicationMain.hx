...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SubparRhythm", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SubparRhythm", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "7";
		app.meta["company"] = "swordcube";
		app.meta["file"] = "SubparRhythm";
		app.meta["name"] = "SubparRhythm";
